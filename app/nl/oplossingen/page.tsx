...
/*
  Oplossingen — YellowSun Power (Dutch mirror of app/solutions/page.tsx)
  Same structure as the French/English versions: intro, four
  property-type profiles, a materials/guarantee feature built around
  the product shot, a compact method strip, closing CTA.
*/
...
const SEGMENTS = [
  {
    label: "Villa's",
    range: "10 – 20 kW gemiddeld",
    desc: "Hoogwaardige residentiële daken: discrete installaties, afgestemd op het werkelijke verbruik van het huishouden in plaats van op een generieke norm, met een resultaat dat opgaat in de architectuur.",
    icon: (
      <path
  ...
  {
    label: "Riads",
    range: "3 – 8 kW gemiddeld",
    desc: "Integratie ontworpen voor traditionele bebouwing: daken in de medina, binnenplaatsen, hellende daken. Elke installatie respecteert de bestaande structuur en blijft onzichtbaar vanaf de straat.",
    icon: (
      <path
  ...
  {
    label: "Hotels",
    range: "20 – 60 kW gemiddeld",
    desc: "Continu, veeleisend verbruik (airconditioning, warm water, keukens) vraagt om nauwkeurige dimensionering en toegewijde productiemonitoring om de belasting het hele jaar door te dragen.",
    icon: (
      <path
  ...
  {
    label: "Bedrijven",
    range: "60 – 100 kW+ gemiddeld",
    desc: "Industriële en commerciële sites: zonnecarports, magazijndaken, opslagfaciliteiten. Krachtige installaties met productiemonitoring om uw rendement op te volgen.",
    icon: (
      <path
...
const METHOD = [
  { title: "Gepersonaliseerd, gratis technisch onderzoek" },
  { title: "Sleutelklare installatie" },
  { title: "Gegarandeerde hoogwaardige apparatuur" },
  { title: "Service overal in Marokko" },
];
...
export default function OplossingenPageNL() {
  return (
    <QuoteModalProvider>
        ...
        <section className="relative w-full bg-[#14120F] pb-16 pt-32 sm:pb-20 sm:pt-40 lg:pb-24 lg:pt-48">
          <div className="mx-auto max-w-[1600px] px-6 sm:px-10 lg:px-14 xl:px-20">
            ...
            <h1 className="mt-6 max-w-2xl text-[clamp(2rem,3.4vw+1rem,3.6rem)] font-medium leading-[1.1] tracking-tight text-[#F5EFE3]">
              Een zonne-oplossing ontworpen voor elk type eigendom.
            </h1>

            <p className="mt-6 max-w-xl text-base leading-relaxed text-[#F5EFE3]/70 sm:text-lg">
              Villa, riad, hotel of bedrijfssite: elk dak heeft zijn eigen
              verbruik, eigen zonligging en eigen architecturale
              beperkingen. Wij dimensioneren elke installatie
              dienovereenkomstig, nooit volgens een standaardmodel.
            </p>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-[1600px] px-6 sm:px-10 lg:px-14 xl:px-20">
            <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-20">
              <div className="relative mx-auto aspect-square w-full max-w-md overflow-hidden rounded-3xl border border-white/10 lg:max-w-none">
                <Image
                  src="/solution.webp"
                  alt="Hoogwaardige zonnepanelen van YellowSun Power"
                  fill
              ...
              <div>
                ...
                <h2 className="mt-4 text-[clamp(1.7rem,2.6vw+1rem,2.6rem)] font-semibold leading-[1.15] tracking-tight text-[#F5EFE3]">
                  Hoogwaardige apparatuur, gegarandeerd op lange termijn.
                </h2>
                <p className="mt-6 max-w-lg text-base leading-relaxed text-[#F5EFE3]/70 sm:text-lg">
                  Wij selecteren onze panelen en omvormers bij dezelfde
                  fabrikanten die onze installaties in Frankrijk
                  uitrusten, met één criterium&nbsp;: de belofte van
                  prestaties op lange termijn nakomen, niet alleen op de
                  dag van ingebruikname.
                </p>
                <div className="mt-8 flex flex-wrap gap-x-10 gap-y-5 border-t border-white/10 pt-6">
                  <div className="flex flex-col gap-1">
                    <span className="text-2xl font-semibold text-[#F5EFE3]">25 jaar</span>
                    <span className="text-xs text-[#F5EFE3]/55">garantie op panelen</span>
                  </div>
                  <div className="flex flex-col gap-1 border-l border-white/10 pl-8">
                    <span className="text-2xl font-semibold text-[#F5EFE3]">70%</span>
                    <span className="text-xs text-[#F5EFE3]/55">mogelijke besparing*</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="w-full bg-[#14120F] py-24 sm:py-32">
          <div className="mx-auto flex max-w-[1600px] flex-col items-center gap-8 px-6 text-center sm:px-10">
            <h2 className="max-w-2xl text-[clamp(1.7rem,2.8vw+1rem,2.8rem)] font-semibold leading-[1.2] tracking-tight text-[#F5EFE3]">
              Wat uw eigendom ook is, er is een passende oplossing.
            </h2>
            <ClosingCTA />
          </div>
        </section>
